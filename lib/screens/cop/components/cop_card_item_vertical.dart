...
class CopCardItemVertical extends StatelessWidget {
  late CopResult model;

  CopCardItemVertical(this.model, int pos, {super.key});
                      ...
                      Text.rich(
                        TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text:
                                    " Diperbarui ${convertDateInfo(model.createdAt)}",
                                style: TextStyle(
